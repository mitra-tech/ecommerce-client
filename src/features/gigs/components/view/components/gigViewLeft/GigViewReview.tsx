...
const GigViewReviews: FC = (): ReactElement => {
  return (
    <>
      <>
        <div className="mb-10">
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col gap-y-3 md:flex-row md:gap-x-4">
          <img className="flex self-center h-12 w-12 mt-4 rounded-full object-cover md:self-auto" src="itemimage" alt="Reviewer Image" />
          <div className="flex flex-col self-center">
            <div className="flex cursor-pointer self-center pt-0 no-underline md:block md:self-start md:pt-4">
              <span className="text-base font-bold md:mb-5">Reviewer username</span>
            </div>
            ...
            <div className="flex w-full gap-x-1 self-center justify-center md:justify-start">
              ...
              <div className="ml-2 mt-[1px] flex gap-1 text-sm">
                <span className="text-orange-400">5</span>|<span>22/01/2025</span>
              </div>
            </div>
